...
export const CONTRACT_ADDRESSES = {
  ...
  TICKETING: import.meta.env.VITE_TICKETING_CONTRACT_ADDRESS || import.meta.env.VITE_REAL_ESTATE_INVESTMENT_ADDRESS,
} as const;
...
export const TICKETING_CONTRACT_ADDRESS = CONTRACT_ADDRESSES.TICKETING;
